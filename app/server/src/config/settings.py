...
class Settings(BaseSettings):
    ...
    intel_event_sync_scheduler_enabled: bool = Field(default=False, alias="INTEL_EVENT_SYNC_SCHEDULER_ENABLED")
    intel_event_sync_scheduler_run_on_startup: bool = Field(default=False, alias="INTEL_EVENT_SYNC_SCHEDULER_RUN_ON_STARTUP")
    intel_event_sync_scheduler_poll_seconds: int = Field(default=300, alias="INTEL_EVENT_SYNC_SCHEDULER_POLL_SECONDS")
    intel_event_sync_feeds: str = Field(default="", alias="INTEL_EVENT_SYNC_FEEDS")
    intel_event_sync_max_records_per_feed: int = Field(default=100, alias="INTEL_EVENT_SYNC_MAX_RECORDS_PER_FEED")
    intel_event_sync_evaluate_geofences: bool = Field(default=True, alias="INTEL_EVENT_SYNC_EVALUATE_GEOFENCES")
